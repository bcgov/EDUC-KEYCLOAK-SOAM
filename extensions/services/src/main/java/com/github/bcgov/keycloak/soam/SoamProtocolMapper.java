...
public class SoamProtocolMapper extends AbstractOIDCProtocolMapper
	...
	protected void setClaim(final IDToken token, final ProtocolMapperModel mappingModel,
		...
		// adds our data to the token. Uses the parameters like the claim name which
		// were set by the user
		// when this protocol mapper was configured in keycloak. Note that the
		// parameters which can
		// be configured in keycloak for this protocol mapper were set in the static
		// intializer of this class.
		//
