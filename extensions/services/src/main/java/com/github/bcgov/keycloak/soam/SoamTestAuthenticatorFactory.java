 ...
 */
public class SoamTestAuthenticatorFactory implements AuthenticatorFactory {

    public static final String PROVIDER_ID = "bcgov-soamtest-client";
    ...
    public String getDisplayType() {
        return "Soam Test Authentication";
    }

    @Override
    public String getHelpText() {
        return "Soam Test Authentication Test";
    }
